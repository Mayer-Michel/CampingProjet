...
final class TypeController extends AbstractController
{
    ...
    #[Route('/admin/new', name: 'app_type_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/{id}', name: 'app_type_show', methods: ['GET'])]
    ...
    #[Route('/admin/{id}/edit', name: 'app_type_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/{id}', name: 'app_type_delete', methods: ['POST'])]
