...
final class RentalController extends AbstractController
{
    ...
    #[Route('/admin/new', name: 'app_rental_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/{id}', name: 'app_rental_show', methods: ['GET'])]
    ...
    #[Route('/admin/{id}/edit', name: 'app_rental_edit', methods: ['GET', 'POST'])]
