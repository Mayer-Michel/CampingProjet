 ...
 */
final class Version20250211100340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hebergement (id INT AUTO_INCREMENT NOT NULL, type_id_id INT DEFAULT NULL, capacity INT NOT NULL, surface INT NOT NULL, disponibilite TINYINT(1) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_4852DD9C714819A0 (type_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, hebergement_id INT DEFAULT NULL, nbr_adults INT NOT NULL, nbr_kids INT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, INDEX IDX_1619C27D9D86650F (user_id_id), INDEX IDX_1619C27D23BB0F66 (hebergement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
