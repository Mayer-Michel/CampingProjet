 ...
 */
final class Version20250212135045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rental (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, hebergement_id INT DEFAULT NULL, nbr_adult INT NOT NULL, nbr_children INT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, INDEX IDX_1619C27DA76ED395 (user_id), INDEX IDX_1619C27D23BB0F66 (hebergement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
